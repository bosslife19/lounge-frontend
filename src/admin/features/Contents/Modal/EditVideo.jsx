...
export const EditVideo = ({ isOpen, onClose, setVideos, setRefresh, videoData }) => {
  ...
  const handlePost = async () => {
    ...
    const response = await makeRequest("/update-video", {
      ...
      <Portal>
        ...
        <Dialog.Positioner px={5}>
          <Dialog.Content borderRadius="lg" bg="#FAFAFA" p={4}>
            ...
            <Stack spacing={0}>
              <Heading>Edit Video Content</Heading>
              ...
              <Button
                ...
                disabled={loading}
              >
                {loading || isLoading ? <Spinner /> : "Edit Video"}
              </Button>
            </Stack>
          </Dialog.Content>
        </Dialog.Positioner>
