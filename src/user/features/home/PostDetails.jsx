...
import { Box, Image, Text, Stack, HStack, Button, Flex, InputGroup, Card, Avatar, Textarea } from "@chakra-ui/react";
  ...
  return (
   ...
   <Flex bg={'#FAFAFA'} flexDirection={{base:'column',md:'row'}} alignItems={'flex-start'} justifyContent={'space-between'}>
    ...
    <Box w={{base:'100%',md:'30%'}}  className="pb={4}">
          <Text pl={4} pt={3} mb={-2} color={'#101928'} fontWeight={'medium'}>More Posts</Text>
          <Box >
