    ...
    <Card.Root>
      ...
      >
        ...
        >
          ...
          {/* Main Post */}
          <Stack bg="#fff" p={4} boxShadow="lg" borderRadius={10} spacing={4}>
            <AspectRatio ratio={3 / 2} w="100%">
              <Image
                src={update?.post_image}
                alt={update?.title}
            ...
            {isMobile && update?.body?.length > 180 && (
              <Button
            ...
            <Card.Footer
              ...
              pt={6}
            >
              <Avatar.Root ml={{ base: -5, md: -2 }} mt={-2} size="xs">
                <Avatar.Image
                  src={userDetails?.profile_picture || userAvatar}
                />
              </Avatar.Root>
        ...
        {/* Sidebar - stays hidden or stacked under on mobile */}
        <Box
          w={{ base: "100%", md: "30%" }}
          overflowY="auto"
          boxShadow="xl"
